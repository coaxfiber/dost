...
fagency=''
  ...
  openDialog(x,data): void {
    const dialogRef = this.dialog.open(GrantAddUpdateComponent, {
      width: '500px',data:{ x: x,data:data }, disableClose: false
    });
  ...
  removegrant(id){
    this.swalConfirm("Delete Grant?","You won't be able to revert this!",'warning','Yes','Research has been Removed','','delete',id);
  }
	addtitle
