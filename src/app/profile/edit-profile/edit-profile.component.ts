...
export class EditProfileComponent implements OnInit {
   ...
   constructor(public dialog: MatDialog,public dialogRef: MatDialogRef<EditProfileComponent>,@Inject(MAT_DIALOG_DATA) public data: any,private http: Http,private global: GlobalService) {
