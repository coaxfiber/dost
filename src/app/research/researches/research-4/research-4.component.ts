...
@Component({
  selector: 'app-research-4',
  templateUrl: './research-4.component.html',
  styleUrls: ['./research-4.component.scss']
})
export class Research4Component implements OnInit {
  ...
  createTable() {
        this.http.get(this.global.api + 'api.php?action=spResearch_List&company=' + this.global.useraccess.companyid+"&status=4",
         this.global.option)
            .map(response => response.json())
            .subscribe(res => {
