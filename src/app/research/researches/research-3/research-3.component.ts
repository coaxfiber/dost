...
@Component({
  selector: 'app-research-3',
  templateUrl: './research-3.component.html',
  styleUrls: ['./research-3.component.scss']
})
export class Research3Component implements OnInit {
  ...
  createTable() {
        this.http.get(this.global.api + 'api.php?action=spResearch_List&company=' + this.global.useraccess.companyid+"&status=2",
         this.global.option)
            .map(response => response.json())
            .subscribe(res => {
