...
.imgfea {
  margin-left: auto;margin-right: auto;
    height: 150px;box-shadow: 2px 2px 2px 2px #333;;
  }
img.noStretch{
    object-fit: cover;
  }</style>
            ...
            <div class="item">
              <div class="row">
                <div class="col-md-6 text-right-md item-caption">
                  <h2 class="h1 text-weight-light">
                      <span class="text-primary">CVRDKMS</span> Website
                    </h2>
                  <h4>
                      Developed by USL CICT Team
                    </h4>
                  <p>Cagayan Valley Research and Development Knowledge Management System is a proposed development of an online repository and research grant monitoring system that aims to promote scholarly studies in the region</p>
                  <a href="http://192.168.0.29/dost/index" class="btn btn-more btn-lg"><i class="fa fa-plus"></i> Learn More</a>
                </div>
  ...
  <div id="content">
    ...
    <!--<div class="mission text-center block block-pd-sm block-bg-noise">
      <div class="container">
        ...
        <h1 class="jumbotron-heading">CVRDKMS</h1>
      ...
      <div class="container"> 
        <div class="row" style="margin-top: 7px;">
         ...
         <h2 class="block-title">
            Articles
              ...
              <div class="col-6 col-md-4" style="text-align: right;"><button type="button" class="btn btn-primary btn-sm"><i class="fa fa-search"></i> View More</button></div>
            </div>
        <p></p>
        <div class="item-carousel" data-toggle="owlcarousel" data-owlcarousel-settings='{"items":4, "pagination":false, "navigation":true, "itemsScaleUp":true}'>
          <div class="item">
            <a href="#" class="overlay-wrapper">
              <div style="height: 155px;overflow: hidden;">
                <img src="img/showcase/project1.jpg" alt="Project 1 image" class="img-responsive underlay">
              </div>
                <span class="overlay">
                  <span class="overlay-content"> <span class="h4">RO2 leads the creation of the first DOST research repository in the country</span> </span>
                </span>
              </a>
            <div class="item-details bg-noise">
              <h4 class="item-title">
                  <a href="research">RO2 leads the creation of the first DOST research repository in the country</a>
                </h4>
              <a href="research" class="btn btn-more"><i class="fa fa-plus"></i>View Article</a>
            </div>
          </div>
          <div class="item">
            <a href="research" class="overlay-wrapper">
              <div style="height: 155px;overflow: hidden;">
                <img src="img/showcase/2.jpg" alt="Project 1 image" class="img-responsive underlay">
              </div>
                <span class="overlay">
                  <span class="overlay-content"> <span class="h4">Foundation of Computational...</span> </span>
                </span>
              </a>
            <div class="item-details bg-noise">
              <h4 class="item-title">
                  <a href="research">Foundation of Computational...</a>
                </h4>
              <a href="research" class="btn btn-more"><i class="fa fa-plus"></i>View Paper</a>
            </div>
          </div>
          <div class="item">
            <a href="research" class="overlay-wrapper">
              <div style="height: 155px;overflow: hidden;">
                <img src="img/showcase/3.jpg" alt="Project 1 image" class="img-responsive underlay">
              </div>
                <span class="overlay">
                  <span class="overlay-content"> <span class="h4">jobs.ac.uk</span> </span>
                </span>
              </a>
            <div class="item-details bg-noise">
              <h4 class="item-title">
                  <a href="research">jobs.ac.uk</a>
                </h4>
              <a href="research" class="btn btn-more"><i class="fa fa-plus"></i>View Paper</a>
            </div>
          </div>
          <div class="item">
            <a href="#" class="overlay-wrapper">
              <div style="height: 155px;overflow: hidden;">
                <img src="img/showcase/4.jpg" alt="Project 1 image" class="img-responsive underlay">
              </div>
                <span class="overlay">
                  <span class="overlay-content"> <span class="h4">Cancer Research</span> </span>
                </span>
              </a>
            <div class="item-details bg-noise">
              <h4 class="item-title">
                  <a href="research">Cancer Research</a>
                </h4>
          ...
          <div class="item">
            <a href="#" class="overlay-wrapper">
              <div style="height: 155px;overflow: hidden;">
                <img src="img/showcase/5.jpg" alt="Project 1 image" class="img-responsive underlay">
              </div>
                <span class="overlay">
                  <span class="overlay-content"> <span class="h4">Research on Habits of Mind</span> </span>
                </span>
              </a>
            <div class="item-details bg-noise">
              <h4 class="item-title">
                  <a href="#">Research on Habits of Mind</a>
                </h4>
              <a href="#" class="btn btn-more"><i class="fa fa-plus"></i>Read more</a>
            </div>
          </div>
          <div class="item">
            <a href="#" class="overlay-wrapper">
              <div style="height: 155px;overflow: hidden;">
                <img src="img/showcase/6.jpg" alt="Project 1 image" class="img-responsive underlay">
              </div>
                <span class="overlay">
                  <span class="overlay-content"> <span class="h4">Nguyen en trato lol</span> </span>
                </span>
              </a>
            <div class="item-details bg-noise">
              <h4 class="item-title">
                  <a href="#">Nguyen en trato lol</a>
                </h4>
              <a href="#" class="btn btn-more"><i class="fa fa-plus"></i>Read more</a>
            </div>
          </div>
...
-->
    <div class="block block-pd-sm block-bg-grey-dark block-bg-overlay block-bg-overlay-6 text-center" data-block-bg-img="https://picjumbo.imgix.net/HNCK1088.jpg?q=40&amp;w=1650&amp;sharp=30" data-stellar-background-ratio="0.3">
      ...
      <p>
        <a href="#" class="btn btn-more btn-lg i-right">Apply today! <i class="fa fa-angle-right"></i></a>
      </p>
    </div>
    ...
    <div class="testimonials block-contained">
      <div class="row">
        ...
        <div class="col-md-6 m-b-lg">
          ...
          <blockquote>
            <p>The heart and soul of good writing is research; you should write not what you know but what you can find out about.</p>
            <img src="img/misc/charles-quote.png" alt="Charles Spencer Chaplin">
            <small>
                <strong>Robert J. Sawyer</strong>
                <br>
               Research Director
              </small>
          </blockquote>
